...
import { Gamepad2, Grid3x3, BrainCircuit, Flag, LayoutGrid, Calculator, Palette, Disc, Rocket, Bird, Blocks, Target, Hammer, Type } from 'lucide-react';
...
type GameType = 'menu' | 'tictactoe' | 'snake' | 'memory' | 'pong' | 'minesweeper' | 'breakout' | '2048' | 'simonsays' | 'connectfour' | 'spaceinvaders' | 'flappybird' | 'tetris' | 'asteroids' | 'whackamole' | 'hangman';
...
export default function App() {
  ...
  const games = [
    ...
    },
    {
      id: 'asteroids',
      name: 'Asteroids',
      desc: 'Blast asteroids in space! Break them down and survive.',
      icon: <Target size={32} />,
      color: 'slate',
      category: 'arcade'
    },
    {
      id: 'whackamole',
      name: 'Whack-a-Mole',
      desc: 'Whack as many moles as you can before the time runs out!',
      icon: <Hammer size={32} />,
      color: 'orange',
      category: 'arcade'
    },
    ...
    },
    {
      id: 'hangman',
      name: 'Hangman',
      desc: 'Guess the hidden word one letter at a time before you run out of tries.',
      icon: <Type size={32} />,
      color: 'pink',
      category: 'classic'
    }
